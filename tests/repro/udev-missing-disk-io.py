...
# whether follow-up I/O changes what udev reports, without asserting that it
# must.
#
...
# present. The test forces a read, a write with fsync, and a sync, then prints
# all captured block events plus a filtered subset related to the removed disk.
