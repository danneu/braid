...
# to full boot with btrfs mounted in degraded mode (2 of 3 drives).
#
...
# the system boot and serve data with N-1 drives.
#
# Dependencies: remote-unlock (same 2-machine initrd SSH pattern).
#
