...
---
When a plan proposes updating `docs/principles.md` or `docs/decisions/*` as part of a code change, the doc update must stay at the contract level -- not pin itself to internal implementation names or exact process semantics.
...
**How to apply:** For any plan that touches `docs/principles.md` or `docs/decisions/`:
